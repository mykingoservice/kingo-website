...
const services = [
  "AC repair for homes, residential properties, and nearby rural properties.",
  "AC installation and replacement options for Splendora-area comfort needs.",
  ...
  "Commercial HVAC support for local business properties.",
...
const intakeItems = [
  ...
  "Whether the property is residential, rural, or commercial.",
    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      <section className="grid gap-8 md:grid-cols-[1.3fr_0.7fr] md:items-center">
        <div>
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 md:text-5xl">
            HVAC service for Splendora homes, rural properties, and local businesses
          </h1>
          <p className="mt-6 text-lg leading-8 text-slate-700">
            Kingo Services Heating and Cooling supports Splendora, Texas with practical heating
            and air conditioning service for residential properties, nearby rural properties,
            and local commercial spaces.
          </p>
      ...
      <section className="mt-16">
        ...
        <p className="mt-4 max-w-3xl text-slate-700">
          The goal is simple: identify the issue clearly, explain the practical options, and help
