...
const services = [
  "AC repair for The Woodlands homes, residential properties, and nearby rural properties.",
      ...
      <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700">
            Kingo Services Heating and Cooling serves The Woodlands, Texas homes, nearby rural
