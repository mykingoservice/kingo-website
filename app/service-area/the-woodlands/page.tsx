...
const services = [
  "AC repair for The Woodlands homes and residential properties.",
  ...
  "Commercial HVAC support for The Woodlands-area local businesses.",
    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">
            The Woodlands HVAC service area
          </p>
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">
            The Woodlands HVAC Service Area
          </h1>
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-700">
            Kingo Services Heating and Cooling serves The Woodlands, Texas with practical heating and cooling support for homes, residential properties, and local businesses.
          </p>
        ...
        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
          <h2 className="text-xl font-bold text-slate-950">The Woodlands service intake</h2>
      ...
      <section className="mt-16">
        <h2 className="text-3xl font-bold tracking-tight text-slate-950">
          Heating and cooling services in The Woodlands
        </h2>
      ...
      <section className="mt-16 rounded-3xl bg-slate-950 p-8 text-white">
        <h2 className="text-3xl font-bold tracking-tight">
          Need AC, heating, maintenance, commercial HVAC, or emergency help in The Woodlands?
        </h2>
