...
const services = [
  "AC repair for homes, residential properties, and residential properties.",
    ...
    <main className="mx-auto max-w-6xl px-6 py-16">
      <section className="grid gap-8 md:grid-cols-[1.3fr_0.7fr] md:items-center">
        <div>
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 md:text-5xl">
            HVAC service for Houston homes, rural properties, and local businesses
          </h1>
          <p className="mt-6 text-lg leading-8 text-slate-700">
            Kingo Services Heating and Cooling supports Houston, Texas with practical heating
            and air conditioning service for residential properties, residential properties,
      ...
      <section className="mt-16 rounded-3xl bg-slate-950 p-8 text-white">
        ...
        <p className="mt-4 max-w-3xl text-slate-300">
          ...
          address, nearby cross streets, or building, unit, gate, or access details so the call can be handled faster.
        </p>
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            href={PHONE_HREF}
