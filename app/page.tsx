    ...
    <div className="home-page">
      <section className="home-hero">
        <div className="home-hero-copy">
          ...
          <h1>
            Emergency HVAC, AC repair, and heating service across Northeast
            Greater Houston.
          </h1>
          ...
          <p className="hero-text" style={{ marginTop: "0.75rem" }}>
            Emergency and after-hours availability depends on location,
            schedule, and current call volume. Any emergency or after-hours
            dispatch charges are explained before the appointment is confirmed.
          </p>
        </div>
      ...
      <section className="home-section comfort-section">
        <div>
          ...
          <h2>
            AC stopped cooling, no heat, weak airflow, system down, or comfort
            risk rising?
          </h2>
        </div>
        <p>
      ...
      <section className="home-section area-section">
        <div className="section-heading">
          ...
          <h2>
            HVAC service from Splendora into the Northeast Greater Houston
            corridor.
          </h2>
      ...
      <section className="home-section">
        <div className="section-heading">
          ...
          <h2>
            Clear service paths, owner-operator accountability, and no fake
            urgency.
          </h2>
        </div>
      ...
      <section className="home-section split-section">
        <div className="split-card">
          ...
          <h2>
            Emergency and after-hours HVAC intake for serious heating and
            cooling issues.
          </h2>
          <p>
        ...
        <div className="split-card">
          ...
          <h2>
            Real jobs, reviews, photos, and service-area proof build the
            authority.
          </h2>
          <p>
            Kingo is building local SEO through real HVAC work, Completed Job
            Pins™, reviews, videos, and service-area pages instead of generic
            city-page fluff.
          </p>
          <Link href="/completed-job-pins">View Recent Work</Link>
        </div>
      </section>
      ...
      <section className="final-cta">
        ...
        <h2>
          Call now, open Emergency HVAC, or book online and tell us what your
          system is doing.
        </h2>
        <div className="hero-actions">
          <a className="home-button home-button-primary" href={PHONE_HREF}>
